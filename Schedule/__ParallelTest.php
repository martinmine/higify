...
$t3 = new ScheduleObject(3, "t3", "In the void", new DateTime("2014-01-01 12:30"), new DateTime("2014-01-01 12:45"));
$t4 = new ScheduleObject(4, "t4", "In the void", new DateTime("2014-01-01 12:40"), new DateTime("2014-01-01 13:00"));
$t5 = new ScheduleObject(5, "t5", "In the void", new DateTime("2014-01-01 12:55"), new DateTime("2014-01-01 13:30"));
$t6 = new ScheduleObject(6, "t6", "In the void", new DateTime("2014-01-01 13:00"), new DateTime("2014-01-01 13:15"));
$t7 = new ScheduleObject(7, "t7", "In the void", new DateTime("2014-01-01 13:15"), new DateTime("2014-01-01 13:40"));
/*
...
$t16 = new ScheduleObject(16, "t13", "In the void", new DateTime("2014-01-01 15:00"), new DateTime("2014-01-01 15:30"));
*/
