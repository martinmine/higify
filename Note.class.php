...
{ 
  ...
  private $ownerName;       //  @var varchar(30) owners username.
   ...
   */
  public function __construct($noteID, $ownerID, $content, $isPublic, $published, $ownerName)
  {
    $this->noteID = $noteID;
   ...
   *
   *  @return varchar(30) owners username.
   */
