...
$tpl->setValue('JS', array('jquery-latest.min', 'menu', 'notefeedback', 'js/jquery-ui-1.10.4.custom', 'wgxpath.install', 'schedule_updater', 'mainpage', 'noteloader', 'searchresults'));
